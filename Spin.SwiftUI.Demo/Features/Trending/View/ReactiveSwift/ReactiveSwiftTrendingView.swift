...
struct ReactiveSwiftTrendingView: View {
            ...
            ZStack {
                VStack {
                    ...
                    List(self.uiSpin.state.viewItems) { viewItem in
                        NavigationLink(destination: self.viewBuilder.makeReactiveSwiftGifView(with: viewItem.id)) {
                            ReactiveSwiftTrendingRowView(title: viewItem.title, isFavorite: viewItem.isFavorite)
                        }
                    }
...
struct ReactiveSwiftTrendingView_Previews: PreviewProvider {
    static var previews: some View {
        ReactiveSwiftTrendingView(uiSpin: ReactiveSwiftUISpin.makeWith(initialState: .idle))
