...
struct RxSwiftGifView_Previews: PreviewProvider {
    static var previews: some View {
        RxSwiftGifView(uiSpin: RxSwiftUISpin.makeWith(initialState: .loading(id: "")))
    }
}
